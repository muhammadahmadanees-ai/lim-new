...
const FAQ = () => {
  ...
  const faqs = [
    ...
    { question: 'What sizes are available?', answer: `Our standard tile sizes are ${dynamicSizes}. We also offer fully custom sizes for bespoke projects — contact us to discuss your requirements.` },
    ...
    { question: 'What is the minimum order quantity?', answer: 'For standard collections, the minimum order is <strong>20 sqm</strong>. For custom and bespoke orders, minimums may vary.' },
  ];
